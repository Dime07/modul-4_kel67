 ...
 */
package modul4_kel67;

/**
 *
 * @author acer
 */
public class Modul4_kel67 {
// non-return type dengan parameter
    ...
    static void cetak1(){
        ...
        System.out.println("Dimas Rafi dan Dava safgi");
    }
    ...
    public static void main(String[] args) {
        ...
        objek.greeting();
        objek.kelompok("Kelompok 67");
        String print = objek.kenalan("Dimas Rafi", "desain");
